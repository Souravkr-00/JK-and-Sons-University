      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className=" flex flex-col items-start">
            <div className="flex items-center space-x-3   ">
              <img src="/assets/Images/logo.png" alt="College Logo" className="w-20 h-30" />
            </div>
            ...
            <div className="flex items-center space-x-4">
              <a href="#" className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:bg-white hover:text-black transition-all">
                <Facebook size={16} />
              </a>
              <a href="#" className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:bg-white hover:text-black transition-all">
                <Twitter size={16} />
          ...
          {footerLinks.map((section) => (
            <div key={section.title}>
              <h3 className="text-white font-serif font-bold mb-6 tracking-wide underline underline-offset-8 decoration-white/30">
                {section.title}
              </h3>
          ...
          <div>
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center space-x-3 group">
                ...
                <a 
                  href="mailto:collegeofarmenia@gmail.com" 
            ...
            <div className="mt-8">
              <button className="bg-white text-blue-950 px-6 py-3 rounded-sm font-bold text-xs tracking-widest uppercase hover:bg-white transition-all w-full">
                Enquire Now
              </button>
            </div>
          </div>
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs text-gray-500 font-medium tracking-wider text-center md:text-left">
            © 2026 College of Armenia. All rights reserved. 
