  ...
  return (
    <div className="min-h-screen bg-app-bg flex flex-col font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-6 leading-tight">
              About <span className="text-gold">Our University</span>
            </h1>
            ...
            >
              ...
              <div className="flex items-center space-x-6">
                <div className="flex flex-col">
                  <span className="text-3xl font-serif font-bold text-navy">{new Date().getFullYear() - aboutData.established}</span>
                  <span className="text-[0.6rem] font-bold uppercase tracking-widest text-text-muted">Years of Impact</span>
                </div>
                <div className="w-px h-12 bg-gray-100"></div>
                <button className="text-gold font-bold text-[0.7rem] uppercase tracking-widest hover:text-navy transition-colors">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            <span className="text-gold font-bold text-xs uppercase tracking-[0.2em] mb-4 block">University Governance</span>
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-navy">Our <span className="text-gold">Leaders & Founders</span></h2>
          </div>
            ...
            {aboutData.leaders.map((leader, i) => (
              ...
              >
                ...
                <div className="text-center">
                  <h4 className="text-xl font-serif font-bold text-navy mb-1">{leader.name}</h4>
                  <div className="text-[0.65rem] font-bold text-gold uppercase tracking-[0.2em] mb-4">{leader.role}</div>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/3 h-full bg-navy/5 skew-x-12 translate-x-1/4"></div>
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16">
            <div className="bg-blue-950 p-12 md:p-16 rounded-sm shadow-2xl relative group">
              <div className="absolute top-0 right-0 p-8 text-gold/20 group-hover:text-gold/40 transition-colors">
              ...
              <h3 className="text-3xl font-serif font-bold text-white mb-8">Our <span className="text-gold">Vision</span></h3>
              <p className="text-gray-300 text-lg leading-relaxed font-light italic border-l-2 border-gold/50 pl-8">
                {aboutData.vision}
              </p>
            </div>
            
            <div className="bg-gold p-12 md:p-16 rounded-sm shadow-2xl relative group">
              ...
              <p className="text-navy/80 text-lg leading-relaxed font-semibold pl-8 border-l-2 border-navy/30">
                {aboutData.mission}
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/3">
              <span className="text-gold font-bold text-xs uppercase tracking-[0.2em] mb-4 block">Trust & Quality</span>
              <h2 className="text-3xl font-serif font-bold text-navy mb-6">Accreditations & <span className="text-gold">Global Recognition</span></h2>
              <p className="text-text-muted text-sm leading-relaxed mb-8">
                Every program at JK & Sons University adheres to international academic standards, ensuring your degree is recognized worldwide.
              </p>
            ...
            <div className="lg:w-2/3 grid sm:grid-cols-2 gap-4">
              {aboutData.accreditations.map((item, i) => (
                <div key={i} className="flex items-center space-x-4 bg-white p-6 rounded-sm border border-gray-100 shadow-sm">
                  ...
                  <span className="text-xs font-bold text-navy uppercase tracking-wider leading-tight">{item}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-24 bg-navy relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] border border-gold rounded-full animate-pulse"></div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] border border-gold/50 rounded-full"></div>
        </div>
        
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 text-center">
          <Globe2 size={48} className="text-gold mx-auto mb-8" />
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-white mb-8">A Global <span className="text-gold">Learning Hub</span></h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="p-8 border border-white/10 rounded-sm backdrop-blur-sm">
                <div className="text-2xl font-bold text-gold mb-1">{item.value}</div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              <span className="text-gold font-bold text-xs uppercase tracking-[0.2em] mb-4 block">Our Environment</span>
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-navy">World-Class <span className="text-gold">Facilities</span></h2>
            </div>
            <Link to="#" className="text-xs font-bold uppercase tracking-widest text-navy border-b-2 border-gold pb-1 hover:text-gold transition-colors flex items-center group">
              View Virtual Tour
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {aboutData.facilities.map((facility, i) => (
              ...
              >
                ...
                <h4 className="text-lg font-serif font-bold text-navy mb-3 group-hover:text-gold transition-colors">{facility.title}</h4>
      ...
      <section className="py-32 bg-gray-50 border-t border-gray-100 text-center">
        <div className="max-w-4xl mx-auto px-6">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-navy text-gold mb-10 shadow-2xl">
          ...
          <p className="text-text-muted text-lg mb-12 max-w-2xl mx-auto leading-relaxed font-light">
            ...
            JK & Sons University offers the platform to reach your full potential.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Link 
              to="/admissions" 
              className="w-full sm:w-auto border-2 border-navy text-navy px-10 py-5 rounded-sm font-bold text-sm tracking-widest uppercase hover:bg-navy hover:text-white transition-all"
            >
