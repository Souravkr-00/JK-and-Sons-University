                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <div className="space-y-2 mb-8 flex-1">
                    {[
                      ...
                      <div
                        key={course}
                        className="flex items-center text-sm text-text-muted font-light"
                      >
                  ...
                  <button className="text-navy font-bold text-xs uppercase tracking-widest border-b border-navy/10 pb-1 hover:border-gold transition-all w-fit mt-auto">
                    View Program Info
                  </button>
                </div>
              </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="space-y-1">
                <h3 className="text-xl lg:text-4xl font-serif font-bold text-navy">
                  MPH | MBA
                </h3>
                <p className="text-[0.7rem] text-text-muted font-bold uppercase tracking-widest">
                  Postgraduate Tracks
                </p>
              </div>
              <div className="space-y-1">
